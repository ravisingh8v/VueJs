<template>
  <section class="d-flex justify-content-center">
    <div
      v-if="!employeeList.length && !loader"
    ...
    <ul class="w-50 my-3" v-else>
      <li
        class="border border-secondary rounded bg-secondary text-white p-2 my-2 d-flex justify-content-between"
    ...
    getAllEmployeeData() {
      ...
      fetch(
        ...
        .then((res) => {
          ...
          this.employeeList = employeeList.sort((a, b) => {
